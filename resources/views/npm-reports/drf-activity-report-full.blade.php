        ...
        <h4>Development Results Framework (DRF) of the
            ...
            <table style="width:100%;">
                ...
                <tr style="background-color:#c6e0b4; text-align:center;">
                    ...
                    <th>{{ $L['target'] }} <br> {{ $Controller::entoBn($yearR, 'number', $lng) }}</th>
                    <th>{{ $L['Current'] }}</th>
                    <th>{{ $L['dataSources'] }}</th>
                    <th>{{ $L['Comments'] }}</th>
                </tr>
                            ...
                            @foreach ($value as $key2 => $value2)
                                <tr>
                                    <td style="text-align: center !important; vertical-align: top;">
                                        {{ $Controller::entoBn($num++, 'number', $lng) }}</td>
                                    ...
                                    <td style="vertical-align: top;">
                                        ...
                                        @foreach ($value2 as $i => $indicator)
                                            @if ($indicator->indicatorId == $indicator->drfChildIndicatorid)
                                                @if (isset($indicator->drfIndicator->baseLineEntry))
                                                    <span>
                                                        {{ $indicator->drfIndicator->baseLineEntry }}
                                                    </span>
                                                @endif
                                            @endif
                                        @endforeach
                                    ...
                                    <td style="vertical-align: top;">
                                        @foreach ($value2 as $i => $indicator)
                                            @if ($indicator->indicatorId == $indicator->drfChildIndicatorid)
                                                <span>
                                                    @if (isset($indicator->drfIndicator->dataSourcesStr))
                                                        <?php echo $indicator->drfIndicator->dataSourcesStr; ?>
                                                    @endif
                                                </span>
                                            @endif
                                        @endforeach
                                    ...
                                    <td>
                                        ...
                                        <ol>
                                            @foreach ($value2 as $i => $indicator)
                                                @if ($indicator->indicatorId != $indicator->drfChildIndicatorid)
                                                    @if (isset($indicator->comment) && !empty($indicator->comment))
                                                        <li>
                                                            {{ $indicator->comment }}
                                                        </li>
                                                    @endif
