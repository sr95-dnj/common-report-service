...
<body>
    ...
    <div class="right">
        ...
        <table>
            <tr>
                ...
                <td>
            <tr>
                <th rowspan="2" style="text-align: left; width: 25%; "><br>{{$L['Date']}} : </th>
                <td> <br><?php (!empty($goLetterViewArray)) ? $goLetterView->enDate : ""; ?> <br></td>
            </tr>


            <tr>
                <td style="width: 75%;" style="text-align: left;">---------<br>
                    <?php (!empty($goLetterViewArray)) ? $goLetterView->bnDate : "";  ?> </td>
            </tr>
            </td>
            </tr>
        </table>
    ...
    <div>
        <table>
            ...
            <tr>
                ...
                <td><?php (!empty($goLetterViewArray)) ? $goLetterView->enothiNumber : ""; ?></td>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div>
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 80%;">
                    <?php
                    (!empty($goLetterViewArray)) ? $goLetterView->subject : "";
                    ?>
    ...
    <div>
        <?php
        (!empty($goLetterViewArray)) ? $goLetterView->mailBody : "";
        ?>
    </div>
</body>
