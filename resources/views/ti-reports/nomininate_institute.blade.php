    ...
    <div class="container">
        <table class="table-border" style="width:100%; padding: 5px;">
            <tr class=" table-border ">
                <td class="table-border " style="width:5%; ">1</td>
            ...
            <tr class=" table-border ">
                ...
                <td class="table-border">
                    {{$profileModelResponse->headOfInstituteName}},
                    {{$profileModelResponse->email}},
