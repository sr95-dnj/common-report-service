...
<body>
    ...
    <thead>
          <tr>
                ...
                <th style="width: 15%; padding: 2px; ">পদবি</th>
                <th style="width: 25%; padding: 2px; ">নাম</th>
                <th style="width: 20%; padding: 2px; ">শাখা</th>
...
<table class="center" style="text-align: center; padding: 5px;">
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: left; width: 15%; padding: 2px;">
                <span>
                <span>{{$Controller::enToBnConveter($Controller::dateFormatter(optional($list)->distributionDate))}} তারিখ হতে</span> 
                </span> 
                </td>
            </tr>
            @endforeach
