...
<div style="font-size: 24px;">
    ...
    <table width="100%" style="table-layout: fixed; border-collapse: collapse; border-top: 0.5px solid;">
        <tr style="text-align: center;">
            ...
            <td style=" border-collapse: collapse; border: 0.5px solid; width: 17%; text-align: center;">ব্যক্তিগত নম্বর ও শাখা</td>
            <td style=" border-collapse: collapse; border: 0.5px solid; width: 25%; text-align: center;">পদবী ও নাম</td>
            <td style=" border-collapse: collapse; border: 0.5px solid; width: 50%; text-align: center;">মন্তব্য</td>
        </tr>
