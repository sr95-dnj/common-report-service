            ...
            <table class="center tbBorder" style="text-align: center; padding: 5px;">
                <thead>
                    <tr>
                        ...
                        <th style="width: 25%; padding: 2px; ">নম্বর /পদবি ও নাম</th>
                        <th style="width: 20%; padding: 2px; ">যোগদানের তারিখ</th>
                        <th style="width: 25%; padding: 2px; ">পাঁচ বছর পূর্তি তারিখ</th>
                        <th style="width: 20%; padding: 2px; ">পোষাক বিতরণের তারিখ</th>
                    </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; width: 25%; padding: 2px;">
                            ...
                            <span>
                                <?php
                                $value = ($list->employee->employeeOfficialInformation) ? $list->employee->employeeOfficialInformation->designation->banglaName : '';
                                echo $value;
                                ?>
                                <br>
                        ...
                        <td style="width: 20%; padding: 2px;">
                            <span>
                                @if($list->employee->employeeOfficialInformation)
                                {{$Controller::enToBnConveter($Controller::dateFormatter($list->employee->employeeOfficialInformation->joiningDate))}}
                                @endif
                            </span>
                        </td>
