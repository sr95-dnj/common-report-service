...
<body>
    ...
    ?>
    <div style="text-align: right; font-size: 30px;"><b>{{$L['Annexure3']}}</b></div><br>
    <br>
            ...
            <tr class="textCenter font-13">
                <td>
                    <?php
                        ...
                        ?>
                <td>{{$goodsWorkAndServiceListList->packageDppTppService}}</td>
                <td>
                    @if($lng == 'en')
                ...
                <td>
                    <?php
                        ...
                        if ($lng == 'en') {
                            echo date('d-m-Y', strtotime($goodsWorkAndServiceListList->invitationForEoi));
                        } else {
                            $d = explode("-", $goodsWorkAndServiceListList->invitationForEoi);
                ...
                <td>
                    <?php
                        $d = explode("-", $goodsWorkAndServiceListList->issueOfRfp);
                        $d2 = explode("T", $d[2]);
                        if ($lng === 'en') {
                            echo $d2[0] . '-';
                            echo $d[1] . '-';
