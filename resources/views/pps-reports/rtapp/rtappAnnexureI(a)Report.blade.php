...
$en = [
    ...
    'ownFund' => 'Own Fund',
    'others' => 'Others',
    'package_as_per_dpp_tpp_goods' => 'Description of Procurement Package as per RDPP/RTAPP Goods',
...
<table class="tbBorder" style="width: 100%; margin-top: 20px">
    ...
    <tr class="textCenter fontBold font-13">
        ...
        <td rowspan="2">{{$L['package_as_per_dpp_tpp_goods']}}</td>
        ...
        <td colspan="3">{{$L['indicative_dates']}}</td>
    </tr>
    <tr class="textCenter fontBold font-13">
    ...
    foreach ($rtappGoodsAndServiceList->list as $index=> $rtappGoodsAndServiceList){
        ...
        <tr class="textCenter font-13">
            <td>
                ...
                echo $value;
                ?>
            <td>{{$rtappGoodsAndServiceList->tappGoods}}</td>
            <td>
                @if($lng == 'en')
            ...
            <td>
                ...
                if($lng == 'en'){
                    echo date('d-m-Y', strtotime($rtappGoodsAndServiceList->invitationForTender));
                }
                else{
                    $d = explode("-",$rtappGoodsAndServiceList->invitationForTender);
    ...
    <?php } ?>
    <tr class="textCenter fontBold font-13">
        <td colspan="2">{{$L['goods_procurement']}}</td>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
