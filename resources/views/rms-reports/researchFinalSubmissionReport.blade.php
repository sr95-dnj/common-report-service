...
<?php
        ...
        'hashTag'=> 'হ্যাশট্যাগ (ইংলিশ)',
        'hashTagBn'=> 'হ্যাশট্যাগ (বাংলা)',
        'conclusion'=> 'উপসংহার',
        'status'=> 'অবস্থা',        
        'previous'=> 'পূর্ববর্তী',
        'save'=> 'সেভ করুন',
	...
	?>
     ...
     <?php if ( !empty($proposal_obj)) { ?> 
      ...
      <!-- start hashTag -->
      <?php if ( !empty($request_data->hashTagBn)) { ?>
          <div class="grid grid-cols-1 p-3 bg-white margin-top" >
              <div>
                  <span class="text-xl fontBold">{{$L['hashTagBn']}} </span>
                  <div class="text-justify">{!! $request_data->hashTagBn ? $request_data->hashTagBn : "" !!}</div>
              </div>
          </div>
      <?php } ?>
      <!-- end hashTag -->
