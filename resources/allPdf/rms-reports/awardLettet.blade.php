                    ...
                    <div class="mt-5">
                        ...
                        <div class="mt-5">
                            <table class="w-full" align="right">
                                <tbody>
                                    <tr>
                                        <td rowspan="2" style="width : 95%;"><span>
                                                <strong>{{$L['MemorandumNo']}}
                                                </strong>:</span>
                                            {{$request_data->memorandumNo}}
                                        </td>

                                        <td rowspan="2" style=" width : 100px; text-align : center; ">
                                            <span><strong>{{$L['Date']}}</strong></span>
                                        </td>

                                        <td> {{$request_data->nothiDateEn}} </td>
                                    </tr>
                                    <tr>
                                        <td style="border-top : 1px solid #595959;">
                                        -------------------------------<br>
                                            {{$request_data->nothiDateBn}}
                                        </td>
                                    </tr>
